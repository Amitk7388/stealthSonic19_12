...
class CustomOrder extends Component {
    ...
    render() {
       if(this.state.checker == "both"){
           ...
           //var total2 = (this.state.priceShellBoth)
          // var total = total1+total2;
          //alert(this.state.price + "after  "  + this.state.priceBoth + "   shellPrice   " +  this.state.bothShellPrice)
       }else {
    ...
    //    if(this.state.checker == "both"){
    //     var total2 = (this.state.price)+(this.state.priceShellBoth)
    //     alert(this.state.price + "after " + this.state.priceShellBoth )
    //     }else {
    //     var total1 = (this.state.priceShellLeft)+(this.state.priceShellRight)+(this.state.price)
    //      alert(this.state.price +  "else " + this.state.priceShellLeft + " left" + this.state.priceShellRight )
    //     }
    ...
    <img className="responsive shell-left" id="adel-mask-preload-left"  src={this.state.leftShell} />
            ...
            <div class="leftEarpieceCustomisation" style={{float: "left", width: "max-content"}}>
                                 ...
                                 <img className="responsive logoooo st-logo-left" style={{width:"86px", paddingRight:"-62px", marginLeft:"0", marginTop:"0", zIndex: "1", position: 'relative', display: this.state.defaultLogoLeftVisibility,transform:this.state.defaultLeftLogoT}} id="adel-mask-preload-left"  src={this.state.defaultLogoLeft}/>
...
<div style={{ marginRight: "76px"}}>
           ...
           <img className="responsive front-faceplate-right" src={this.state.right}/>
            ...
            <div class="rightEarpieceCustomisation" style={{float: "none", width: "max-content"}}>
                               ...
                               <img className="responsive st-logo-right" style={{width:"86px", marginLeft:"0", marginTop:"0px", zIndex: "1", position: 'relative', display: this.state.defaultLogoRightVisibility,transform: 'translate(397px, 200px)'}}  src={this.state.defaultLogoRight}/>
