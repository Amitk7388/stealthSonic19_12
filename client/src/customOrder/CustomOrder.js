...
class CustomOrder extends Component {
    constructor(props) {
        ...
        this.state={
            ...
            rightUploadedText:"",
            leftUploadedText:"",
            defaultLeftLogoT : "translate(145px,215px)",
                    ...
                    <section>
                        <div className="col-md-6">
                            <div className="row">            
                                ...
                                <img style={{display:"", width:"auto", height:"360px", marginLeft: '-225px', marginTop: "-15px", position: 'absolute'}}  src={require('../../assets/image/SS_U9_side.png')}/>

<div style={{display: "block"}}>
<img className="responsive mainImg" style={{width:"202px", height:"329px", marginTop:"-13px", zIndex:"-1px", marginLeft:"-197px", position: 'absolute', transfrom:'translate(-197px, -14px)'}} id="adel-mask-preload-left"  src={this.state.left} />

<img className="responsive" style={{display:"", width:"249px", height:"326px", marginLeft:"0", marginTop:"0", position: 'absolute', transform: "translate(-216px, -10px)"}} id="adel-mask-preload-left"  src={this.state.leftShell} />
            ...
            <div class="leftEarpieceCustomisation" style={{float: "left", width: "max-content"}}>
                                 ...
                                 <img className="responsive logoooo" style={{width:"86px", paddingRight:"-62px", marginLeft:"0", marginTop:"0", zIndex: "1", borderRadius:"30%", position: 'relative', display: this.state.defaultLogoLeftVisibility,transform:this.state.defaultLeftLogoT}} id="adel-mask-preload-left"  src={this.state.defaultLogoLeft}/>

                                 <img className="responsive" style={{width:"86px", height:"86px", paddingRight:"-62px", marginLeft:"0", marginTop:"0px", zIndex: "1", borderRadius:"30%", position: 'absolute',display:this.state.leftImageVisibility, transform: 'translate(145px, 165px)'}} id="adel-mask-preload-left"  src={this.state.leftUploadedImage}/>
...
<div style={{ marginRight: "76px"}}>
           ...
           <img className="responsive" style={{width:"202px", height:"327px", marginLeft:"0", position: 'absolute', marginTop:"-10px"}} id="adel-mask-preload-left"  src={this.state.right}/>
                              
                              <img className="responsive" style={{ width:"211px", height:"341px", marginLeft:"0", marginTop:"-20px", position: 'absolute',transform: "translateX(-20px)"}} id="adel-mask-preload-left"  src={this.state.rightShell}/>
                              </div>
            ...
            <div class="rightEarpieceCustomisation" style={{float: "none", width: "max-content"}}>
                               ...
                               <img className="responsive" style={{width:"86px", marginLeft:"0", marginTop:"0px", zIndex: "1", borderRadius:"30%", position: 'relative', display: this.state.defaultLogoRightVisibility,transform: 'translate(380px, 200px)'}}  src={this.state.defaultLogoRight}/>
                              
                              <img className="responsive" style={{width:"86px", paddingRight:"-62px", display:this.state.rightImageVisibility ,marginLeft:"0", marginTop:"0px", zIndex: "1", borderRadius:"30%", position: 'relative',height:"86px", transform: 'translate(385px, 150px)'}}  src={this.state.rightUploadedImage}/>
                              ...
                              <span id="rightUploadedTextID" style={{fontSize: "20px", marginTop:"0", transform: "translate(365px, 200px)", marginLeft: "40px", position: "inherit", zIndex: 1, color: this.state.rightCaseColor}}>{this.state.rightUploadedText}</span>
                                ...
                                {/* <img className="responsive" id="logo1" style={{width:"86px", paddingRight:"-62px", marginLeft:"-121px", marginTop:"-356px", zIndex: "1", borderRadius:"30%", position: 'initial'}}  src={this.state.uploadleftLogo2}/>
                                ...
                                <div className="product-preview" style={{display:this.state.casingChecker}}>
                                <img style={{display:"", width:"auto", height:"331px", marginLeft: '60px',marginTop:'79px', position: 'initial'}}  src={require('../../assets/image/case.png')}/>
                        ...
                        <div className="item-specifications">
                            ...
                            <div className="row">
                                ...
                                <div className="col-sm-6">
                                    ...
                                    <label>Type of Earphone : <span>{this.state.cType}</span></label>
                    ...
                    <div className="col-md-3">
                            <div className="price-title p15">
                                <h3>Price</h3>
                                <p>US ${this.state.price}</p>
                                <Link to = "/review"><button className="btn btn-primary btn-block">Next</button></Link>
                            </div>
